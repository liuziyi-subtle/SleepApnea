...
/*
 * @brief  Core function for the Double Precision floating-point CFFT butterfly
 * process.
 * @param[in, out] *pSrc            points to the in-place buffer of F64 data
 * type.
...
/**
  ...
  complex FFT.
  @param[in]     S              points to an instance of the Double Precision
  floating-point CFFT structure
