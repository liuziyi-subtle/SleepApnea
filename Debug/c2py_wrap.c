...
#define SWIGTYPE_p_float_array swig_types[2]
...
SWIGINTERN PyObject *_wrap_CalcBreathRate(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  float *arg1 = (float *) 0 ;
  uint16_t arg2 ;
  uint16_t arg3 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "CalcBreathRate", 3, 3, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_float, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "CalcBreathRate" "', argument " "1"" of type '" "float *""'"); 
  }
  arg1 = (float *)(argp1);
  ecode2 = SWIG_AsVal_unsigned_SS_short(swig_obj[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "CalcBreathRate" "', argument " "2"" of type '" "uint16_t""'");
  } 
  arg2 = (uint16_t)(val2);
  ecode3 = SWIG_AsVal_unsigned_SS_short(swig_obj[2], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "CalcBreathRate" "', argument " "3"" of type '" "uint16_t""'");
  } 
  arg3 = (uint16_t)(val3);
  result = (uint8_t)CalcBreathRate(arg1,arg2,arg3);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "CalcBreathRate", _wrap_CalcBreathRate, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
